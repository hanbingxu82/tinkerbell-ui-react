 ...
 * @LastEditTime: 2022-05-11 16:35:42
...
const SubMenu: any = React.forwardRef((props: any, _ref: any) => {
  ...
  return (
    <li
      ref={subRef}
      style={props.style}
      className={classnames('tb-submenu', {
        'is-active': state.active,
        'is-opened': opened()
      })}
    >
      <div ref={subTitleRef} className='tb-submenu__title'>
        {props.title}
        <i
          className={classnames(
            'tb-submenu__icon-arrow',
            'iconfont',
            'icon-arrow-down'
          )}
        ></i>
      ...
      {rootMenu(props).props.mode === 'horizontal' ? (
        ...
        >
          {({ className, style }) => (
            <ul
              className={classnames('tb-menu', className)}
              style={{ ...style }}
            >
